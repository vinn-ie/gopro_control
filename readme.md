...
The capture rate is pretty slow, like 1 pic every 4-5 seconds max speed, though I think it can be done much better than it is right now. The HTTP request system isn't super stable.
